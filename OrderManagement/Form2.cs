...
namespace OrderManagement
{
    public partial class Form2 : Form
    {
        ...
        private void SetUpDataGridView1()
        {
            ...
            DataGridView1.DataSource = DataEntity();
            DataGridView1.TopLeftHeaderCell.Value = "OrderNAJA";
            ...
            DataGridView1.Columns.Remove(ColumnName.Description.ToString());
        ...
        private DataTable ssRetrieveAlternativeTitles()
        {
            return DataEntity();
        }
        ...
        private void AddOutOfOfficeColumn()
        {
            ...
            //{
            //    column.HeaderText = ColumnName.OrderStatus.ToString();
            //    column.Name = ColumnName.OrderStatus.ToString();
            //    column.AutoSizeMode =
        ...
        private void PopulateSales(DataGridViewCellEventArgs buttonClick)
        {
            ...
            //    .Cells[ColumnName.ProductID.ToString()].Value.ToString();
            //DataGridView2.DataSource = Populate("SELECT * FROM Orders WHERE EmployeeId = " + ProductID);
        }
        ...
        private DataGridViewCell RetrieveSuperiorsLastNameCell(string employeeId)
        {
            ...
            foreach (DataGridViewRow row in DataGridView1.Rows)
            {
                ...
                if (row.Cells[ColumnName.ProductID.ToString()].Value.ToString().Equals(employeeId))
                {
                    return row.Cells[ColumnName.ProductName.ToString()];
                }
            }
            return null;
        }
        ...
        private bool IsCheckBoxColumn(int columnIndex)
        {
            DataGridViewColumn outOfOfficeColumn =
                DataGridView1.Columns[ColumnName.OrderStatus.ToString()];
